function getMovies() {
 ...
 <div class="card-header" id="heading">
   <h5 class="mb-0">
     <button class="btn btn-link" id="buy-ticket" data-toggle="collapse" data-target="#collapse" aria-expanded="true" aria-controls="collapse">
        Buy Ticket
             </button>
   </h5>
 </div>
 <div id="collapse" class="collapse show" aria-labelledby="heading" data-parent="#accordion">
   <div class="card-body">
     ...
     <p>Showtime: ${i.showtime}</p>
     <img src=${i.poster} alt="" height="200">
   </div>
 </div>
</div>
